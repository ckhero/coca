...
INSERT INTO `co_activity` VALUES (1,'Chapter','关卡',''),(2,'WorldBoss','世界boss',NULL),(3,'Day','日常答题',NULL);
...
CREATE TABLE `co_chapter_child` (
  ...
  `guide` text,
  `guide_bg_url` varchar(255) DEFAULT NULL,
  `guide_type` char(8) DEFAULT '' COMMENT '课件类型',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `co_chapter_child` VALUES (12,1,'1-2',NULL,111,NULL,NULL,'',NULL,NULL),(13,2,NULL,NULL,2,NULL,NULL,'',NULL,NULL),(14,2,NULL,NULL,22,NULL,NULL,'',NULL,NULL),(15,0,NULL,NULL,0,NULL,NULL,'','2018-02-06 08:52:40','2018-02-06 08:52:40'),(16,0,NULL,NULL,0,NULL,NULL,'','2018-02-06 08:52:47','2018-02-06 08:52:47'),(17,0,'string','string',1,'string','uploads/20180202/46b0ba04-ca6c-12e4-b90d-803aaeef5e39.jpg','','2018-02-09 10:02:45','2018-02-09 10:02:45');
...
INSERT INTO `co_chapter_child_question` VALUES (12,1),(12,2),(12,1),(12,2),(17,0);
...
INSERT INTO `co_map` VALUES (6,'2',NULL,0,NULL,NULL,NULL);
...
INSERT INTO `co_migration` VALUES ('m141106_185632_log_init',1518058070);
...
INSERT INTO `co_question_options` VALUES (1,1,'C',NULL,NULL,NULL),(2,1,'A',NULL,NULL,NULL),(3,2,'A',NULL,NULL,NULL),(4,3,'B',NULL,NULL,NULL),(5,2,'C',NULL,NULL,NULL);
...
INSERT INTO `co_questions` VALUES (1,'2312','A',NULL,NULL),(2,'121211','C',NULL,NULL),(3,'3','B',NULL,NULL);
